...
alias SQLITE_OPEN_READONLY = 0x00000001  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_READWRITE = 0x00000002  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_CREATE = 0x00000004  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_DELETEONCLOSE = 0x00000008  # VFS only
alias SQLITE_OPEN_EXCLUSIVE = 0x00000010  # VFS only
alias SQLITE_OPEN_AUTOPROXY = 0x00000020  # VFS only
alias SQLITE_OPEN_URI = 0x00000040  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_MEMORY = 0x00000080  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_MAIN_DB = 0x00000100  # VFS only
alias SQLITE_OPEN_TEMP_DB = 0x00000200  # VFS only
alias SQLITE_OPEN_TRANSIENT_DB = 0x00000400  # VFS only
alias SQLITE_OPEN_MAIN_JOURNAL = 0x00000800  # VFS only
alias SQLITE_OPEN_TEMP_JOURNAL = 0x00001000  # VFS only
alias SQLITE_OPEN_SUBJOURNAL = 0x00002000  # VFS only
alias SQLITE_OPEN_SUPER_JOURNAL = 0x00004000  # VFS only
alias SQLITE_OPEN_NOMUTEX = 0x00008000  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_FULLMUTEX = 0x00010000  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_SHAREDCACHE = 0x00020000  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_PRIVATECACHE = 0x00040000  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_WAL = 0x00080000  # VFS only
alias SQLITE_OPEN_NOFOLLOW = 0x01000000  # Ok for sqlite3_open_v2()
alias SQLITE_OPEN_EXRESCODE = 0x02000000  # Extended result codes
...
alias SQLITE_NOTICE = 27
alias SQLITE_WARNING = 28
alias SQLITE_ROW = 100
alias SQLITE_DONE = 101


alias RESULT_MESSAGES: Dict[Int, StaticString] = {
...
@fieldwise_init
struct sqlite3(Copyable, Movable):
    ...
    fn __init__(out self):
        ...
        """
        try:
            self.lib = DLHandle(".pixi/envs/util/lib/libsqlite3.3.50.4.dylib")
        except e:
            self.lib = abort[DLHandle](String("Failed to load sqlite3 from", "sqlite3.dylib", ":\n", e))
    ...
    fn sqlite3_table_column_metadata(
        ...
        pzDataType: UnsafePointer[UnsafePointer[c_char]],
        pzCollSeq: UnsafePointer[UnsafePointer[c_char]],
